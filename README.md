# ¡Hola! Soy José Castillo 👋

### Profesor de Química | Desarrollador Full Stack | Aprendiz Eterno

Soy un **profesor de química** en transición al mundo del desarrollo de software. Mi enfoque principal es el ecosistema de **Python** y **Django**, donde aplico la lógica analítica de la ciencia para construir soluciones web robustas y eficientes. Actualmente, combino la docencia con la creación de aplicaciones que optimizan el aprendizaje y la gestión de datos.
